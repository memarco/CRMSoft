...
class Client_model extends CI_Model {
	...
	var $table = 'clients';
	var $column_order = array('nom_client','prenom_client','email_client','tel_client','addresse_client','autre_info_client'); //set column field database for datatable orderable
	var $column_search = array('nom_client','prenom_client'); //set column field database for datatable searchable just firstname , lastname , address are searchable
