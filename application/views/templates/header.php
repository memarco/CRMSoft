...
<html>
<head>
<title>CRM | Gestion de dossiers Clients</title>
...
<!-- geo chart -->
    ...
    <!--<script src="lib/html5shiv/html5shiv.js"></script>-->
     <!-- Chartinator  -->
    <script src="<?php echo base_url('vendor/js/chartinator.js') ?>" ></script>
...
<!--skycons-icons-->
<script src="<?php echo base_url('vendor/js/skycons.js') ?>"></script>
<!--//skycons-icons-->
</head>
