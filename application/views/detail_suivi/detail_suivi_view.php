          ...
          function load_tables(numero_dossier){
            $.ajax({
                ...
                success: function(response){
                      ...
                      document.getElementById('btn_save_payment').setAttribute('onclick','add_payment("'+response.data_client.id_dossier+'")');
                      document.getElementById('btn_save_depense').setAttribute('onclick','add_depense("'+response.data_client.id_dossier+'")');
  ...
  Nouvelle dépense &nbsp;
      ...
      <br/>    <br/>
      <form action="#" id="form-dep" class="form-horizontal">
          <div class="form-body">
  ...
  <!--
            ...
            <div class="form-group">
              ...
              <div class="modal-footer">
                  <button type="button" id="btnSaveDep" onclick="save_depense()" class="btn btn-primary">Save</button>
                  <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
              </div>
          </div>
      </form>
